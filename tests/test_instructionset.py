...
class TestInstructionSet(unittest.TestCase):
    ...
    def test_add(self):
        # actions taken first, instructions to execute, t-cycles to run for, expected conditions post, name
        tests = [
            [ [ A(0x0A), B(0x0B) ], [ 0x80 ], 4, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD B (0x0A + 0x0B)" ],
            [ [ A(0x40), B(0x51) ], [ 0x80 ], 4, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD B (0x40 + 0x51)" ],
            [ [ A(0xFF), B(0x02) ], [ 0x80 ], 4, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD B (0xFF + 0x02)" ],
            [ [ A(0xFF), B(0x01) ], [ 0x80 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD B (0xFF + 0x01)" ],

            [ [ A(0x0A), C(0x0B) ], [ 0x81 ], 4, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD C (0x0A + 0x0B)" ],
            [ [ A(0x40), C(0x51) ], [ 0x81 ], 4, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD C (0x40 + 0x51)" ],
            [ [ A(0xFF), C(0x02) ], [ 0x81 ], 4, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD C (0xFF + 0x02)" ],
            [ [ A(0xFF), C(0x01) ], [ 0x81 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD C (0xFF + 0x01)" ],

            [ [ A(0x0A), D(0x0B) ], [ 0x82 ], 4, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD D (0x0A + 0x0B)" ],
            [ [ A(0x40), D(0x51) ], [ 0x82 ], 4, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD D (0x40 + 0x51)" ],
            [ [ A(0xFF), D(0x02) ], [ 0x82 ], 4, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD D (0xFF + 0x02)" ],
            [ [ A(0xFF), D(0x01) ], [ 0x82 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD D (0xFF + 0x01)" ],

            [ [ A(0x0A), E(0x0B) ], [ 0x83 ], 4, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD E (0x0A + 0x0B)" ],
            [ [ A(0x40), E(0x51) ], [ 0x83 ], 4, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD E (0x40 + 0x51)" ],
            [ [ A(0xFF), E(0x02) ], [ 0x83 ], 4, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD E (0xFF + 0x02)" ],
            [ [ A(0xFF), E(0x01) ], [ 0x83 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD E (0xFF + 0x01)" ],

            [ [ A(0x0A), H(0x0B) ], [ 0x84 ], 4, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD H (0x0A + 0x0B)" ],
            [ [ A(0x40), H(0x51) ], [ 0x84 ], 4, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD H (0x40 + 0x51)" ],
            [ [ A(0xFF), H(0x02) ], [ 0x84 ], 4, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD H (0xFF + 0x02)" ],
            [ [ A(0xFF), H(0x01) ], [ 0x84 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD H (0xFF + 0x01)" ],

            [ [ A(0x0A), L(0x0B) ], [ 0x85 ], 4, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD L (0x0A + 0x0B)" ],
            [ [ A(0x40), L(0x51) ], [ 0x85 ], 4, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD L (0x40 + 0x51)" ],
            [ [ A(0xFF), L(0x02) ], [ 0x85 ], 4, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD L (0xFF + 0x02)" ],
            [ [ A(0xFF), L(0x01) ], [ 0x85 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD L (0xFF + 0x01)" ],

            [ [ A(0x0A), M(0x1BBC,0x0B), HL(0x1BBC) ], [ 0x86 ], 7, [ (PC==0x01), (A == 0x15), (F==0x00) ], "ADD (HL) (0x0A + 0x0B)" ],
            [ [ A(0x40), M(0x1BBC,0x51), HL(0x1BBC) ], [ 0x86 ], 7, [ (PC==0x01), (A == 0x91), (F==0x84) ], "ADD (HL) (0x40 + 0x51)" ],
            [ [ A(0xFF), M(0x1BBC,0x02), HL(0x1BBC) ], [ 0x86 ], 7, [ (PC==0x01), (A == 0x01), (F==0x05) ], "ADD (HL) (0xFF + 0x02)" ],
            [ [ A(0xFF), M(0x1BBC,0x01), HL(0x1BBC) ], [ 0x86 ], 7, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD (HL) (0xFF + 0x01)" ],

            [ [ A(0x0A) ], [ 0x87 ], 4, [ (PC==0x01), (A == 0x14), (F==0x00) ], "ADD A (0x0A + 0x0A)" ],
            [ [ A(0x40) ], [ 0x87 ], 4, [ (PC==0x01), (A == 0x80), (F==0x84) ], "ADD A (0x40 + 0x40)" ],
            [ [ A(0x81) ], [ 0x87 ], 4, [ (PC==0x01), (A == 0x02), (F==0x05) ], "ADD A (0x81 + 0x81)" ],
            [ [ A(0x80) ], [ 0x87 ], 4, [ (PC==0x01), (A == 0x00), (F==0x45) ], "ADD A (0x80 + 0x80)" ],

            [ [ A(0x0A) ], [ 0xC6, 0x0B ], 7, [ (PC==0x02), (A == 0x15), (F==0x00) ], "ADD 0BH (0x0A + 0x0B)" ],
            [ [ A(0x40) ], [ 0xC6, 0x51 ], 7, [ (PC==0x02), (A == 0x91), (F==0x84) ], "ADD 51H (0x40 + 0x51)" ],
            [ [ A(0xFF) ], [ 0xC6, 0x02 ], 7, [ (PC==0x02), (A == 0x01), (F==0x05) ], "ADD 02H (0xFF + 0x02)" ],
            [ [ A(0xFF) ], [ 0xC6, 0x01 ], 7, [ (PC==0x02), (A == 0x00), (F==0x45) ], "ADD 01H (0xFF + 0x01)" ],

            [ [ A(0x0A), M(0x1BBC,0x0B), IX(0x1BB0) ], [ 0xDD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x15), (F==0x00) ], "ADD (IX + CH) (0x0A + 0x0B)" ],
            [ [ A(0x40), M(0x1BBC,0x51), IX(0x1BB0) ], [ 0xDD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x91), (F==0x84) ], "ADD (IX + CH) (0x40 + 0x51)" ],
            [ [ A(0xFF), M(0x1BBC,0x02), IX(0x1BB0) ], [ 0xDD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x01), (F==0x05) ], "ADD (IX + CH) (0xFF + 0x02)" ],
            [ [ A(0xFF), M(0x1BBC,0x01), IX(0x1BB0) ], [ 0xDD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x00), (F==0x45) ], "ADD (IX + CH) (0xFF + 0x01)" ],

            [ [ A(0x0A), M(0x1BBC,0x0B), IY(0x1BB0) ], [ 0xFD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x15), (F==0x00) ], "ADD (IY + CH) (0x0A + 0x0B)" ],
            [ [ A(0x40), M(0x1BBC,0x51), IY(0x1BB0) ], [ 0xFD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x91), (F==0x84) ], "ADD (IY + CH) (0x40 + 0x51)" ],
            [ [ A(0xFF), M(0x1BBC,0x02), IY(0x1BB0) ], [ 0xFD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x01), (F==0x05) ], "ADD (IY + CH) (0xFF + 0x02)" ],
            [ [ A(0xFF), M(0x1BBC,0x01), IY(0x1BB0) ], [ 0xFD, 0x86, 0x0C ], 19, [ (PC==0x03), (A == 0x00), (F==0x45) ], "ADD (IY + CH) (0xFF + 0x01)" ],
            ]
