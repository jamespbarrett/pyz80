...
class TestInstructionSet(unittest.TestCase):
    ...
    def test_sbc(self):
        # actions taken first, instructions to execute, t-cycles to run for, expected conditions post, name
        tests = [
            [ [ A(0x0A), B(0xF5), F(0x00) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC B (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), B(0xAF), F(0x00) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC B (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), B(0xFE), F(0x00) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC B (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), B(0xFF), F(0x00) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC B (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), B(0xF4), F(0x01) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC B (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), B(0xAE), F(0x01) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC B (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), B(0xFD), F(0x01) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC B (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), B(0xFE), F(0x01) ], [ 0x98 ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC B (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), C(0xF5), F(0x00) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC C (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), C(0xAF), F(0x00) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC C (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), C(0xFE), F(0x00) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC C (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), C(0xFF), F(0x00) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC C (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), C(0xF4), F(0x01) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC C (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), C(0xAE), F(0x01) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC C (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), C(0xFD), F(0x01) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC C (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), C(0xFE), F(0x01) ], [ 0x99 ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC C (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), D(0xF5), F(0x00) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC D (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), D(0xAF), F(0x00) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC D (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), D(0xFE), F(0x00) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC D (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), D(0xFF), F(0x00) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC D (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), D(0xF4), F(0x01) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC D (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), D(0xAE), F(0x01) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC D (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), D(0xFD), F(0x01) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC D (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), D(0xFE), F(0x01) ], [ 0x9A ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC D (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), E(0xF5), F(0x00) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC E (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), E(0xAF), F(0x00) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC E (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), E(0xFE), F(0x00) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC E (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), E(0xFF), F(0x00) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC E (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), E(0xF4), F(0x01) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC E (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), E(0xAE), F(0x01) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC E (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), E(0xFD), F(0x01) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC E (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), E(0xFE), F(0x01) ], [ 0x9B ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC E (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), H(0xF5), F(0x00) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC H (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), H(0xAF), F(0x00) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC H (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), H(0xFE), F(0x00) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC H (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), H(0xFF), F(0x00) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC H (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), H(0xF4), F(0x01) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC H (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), H(0xAE), F(0x01) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC H (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), H(0xFD), F(0x01) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC H (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), H(0xFE), F(0x01) ], [ 0x9C ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC H (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), L(0xF5), F(0x00) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC L (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), L(0xAF), F(0x00) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC L (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), L(0xFE), F(0x00) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC L (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), L(0xFF), F(0x00) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC L (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), L(0xF4), F(0x01) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC L (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), L(0xAE), F(0x01) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC L (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), L(0xFD), F(0x01) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC L (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), L(0xFE), F(0x01) ], [ 0x9D ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC L (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), M(0x1BBC,0xF5), F(0x00), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC (HL) (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), M(0x1BBC,0xAF), F(0x00), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC (HL) (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), M(0x1BBC,0xFE), F(0x00), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC (HL) (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), M(0x1BBC,0xFF), F(0x00), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC (HL) (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), M(0x1BBC,0xF4), F(0x01), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x15), (F==0x07) ], "SBC (HL) (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), M(0x1BBC,0xAE), F(0x01), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x91), (F==0x83) ], "SBC (HL) (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), M(0x1BBC,0xFD), F(0x01), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x01), (F==0x02) ], "SBC (HL) (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), M(0x1BBC,0xFE), F(0x01), HL(0x1BBC) ], [ 0x9E ], 7, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC (HL) (0xFF - 0xFE - 1)" ],

            [ [ A(0x00), F(0x00) ], [ 0x9F ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC A (0x0A - 0x0A - 0)" ],
            [ [ A(0x80), F(0x00) ], [ 0x9F ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC A (0x80 - 0x80 - 0)" ],
            [ [ A(0xFF), F(0x00) ], [ 0x9F ], 4, [ (PC==0x01), (A == 0x00), (F==0x42) ], "SBC A (0xFF - 0xFF - 0)" ],

            [ [ A(0x00), F(0x01) ], [ 0x9F ], 4, [ (PC==0x01), (A == 0xFF), (F==0xAB) ], "SBC A (0x0A - 0x0A - 1)" ],
            [ [ A(0x80), F(0x01) ], [ 0x9F ], 4, [ (PC==0x01), (A == 0xFF), (F==0xAB) ], "SBC A (0x80 - 0x80 - 1)" ],
            [ [ A(0xFF), F(0x01) ], [ 0x9F ], 4, [ (PC==0x01), (A == 0xFF), (F==0xAB) ], "SBC A (0xFF - 0xFF - 1)" ],

            [ [ A(0x0A), F(0x00) ], [ 0xDE, 0xF5 ], 7, [ (PC==0x02), (A == 0x15), (F==0x07) ], "SBC F5H (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), F(0x00) ], [ 0xDE, 0xAF ], 7, [ (PC==0x02), (A == 0x91), (F==0x83) ], "SBC AFH (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), F(0x00) ], [ 0xDE, 0xFE ], 7, [ (PC==0x02), (A == 0x01), (F==0x02) ], "SBC FEH (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), F(0x00) ], [ 0xDE, 0xFF ], 7, [ (PC==0x02), (A == 0x00), (F==0x42) ], "SBC FFH (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), F(0x01) ], [ 0xDE, 0xF4 ], 7, [ (PC==0x02), (A == 0x15), (F==0x07) ], "SBC F4H (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), F(0x01) ], [ 0xDE, 0xAE ], 7, [ (PC==0x02), (A == 0x91), (F==0x83) ], "SBC AEH (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), F(0x01) ], [ 0xDE, 0xFD ], 7, [ (PC==0x02), (A == 0x01), (F==0x02) ], "SBC FDH (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), F(0x01) ], [ 0xDE, 0xFE ], 7, [ (PC==0x02), (A == 0x00), (F==0x42) ], "SBC FEH (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), M(0x1BBC,0xF5), F(0x00), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x15), (F==0x07) ], "SBC (IX+CH) (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), M(0x1BBC,0xAF), F(0x00), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x91), (F==0x83) ], "SBC (IX+CH) (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), M(0x1BBC,0xFE), F(0x00), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x01), (F==0x02) ], "SBC (IX+CH) (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), M(0x1BBC,0xFF), F(0x00), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x00), (F==0x42) ], "SBC (IX+CH) (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), M(0x1BBC,0xF4), F(0x01), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x15), (F==0x07) ], "SBC (IX+CH) (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), M(0x1BBC,0xAE), F(0x01), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x91), (F==0x83) ], "SBC (IX+CH) (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), M(0x1BBC,0xFD), F(0x01), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x01), (F==0x02) ], "SBC (IX+CH) (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), M(0x1BBC,0xFE), F(0x01), IX(0x1BB0) ], [ 0xDD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x00), (F==0x42) ], "SBC (IX+CH) (0xFF - 0xFE - 1)" ],

            [ [ A(0x0A), M(0x1BBC,0xF5), F(0x00), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x15), (F==0x07) ], "SBC (IY+CH) (0x0A - 0xF5 - 0)" ],
            [ [ A(0x40), M(0x1BBC,0xAF), F(0x00), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x91), (F==0x83) ], "SBC (IY+CH) (0x40 - 0xAF - 0)" ],
            [ [ A(0xFF), M(0x1BBC,0xFE), F(0x00), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x01), (F==0x02) ], "SBC (IY+CH) (0xFF - 0xFE - 0)" ],
            [ [ A(0xFF), M(0x1BBC,0xFF), F(0x00), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x00), (F==0x42) ], "SBC (IY+CH) (0xFF - 0xFF - 0)" ],

            [ [ A(0x0A), M(0x1BBC,0xF4), F(0x01), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x15), (F==0x07) ], "SBC (IY+CH) (0x0A - 0xF4 - 1)" ],
            [ [ A(0x40), M(0x1BBC,0xAE), F(0x01), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x91), (F==0x83) ], "SBC (IY+CH) (0x40 - 0xAE - 1)" ],
            [ [ A(0xFF), M(0x1BBC,0xFD), F(0x01), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x01), (F==0x02) ], "SBC (IY+CH) (0xFF - 0xFD - 1)" ],
            [ [ A(0xFF), M(0x1BBC,0xFE), F(0x01), IY(0x1BB0) ], [ 0xFD, 0x9E, 0x0C ], 19, [ (PC==0x03), (A == 0x00), (F==0x42) ], "SBC (IY+CH) (0xFF - 0xFE - 1)" ],
            ]
